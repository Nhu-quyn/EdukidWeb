...
const ListTopic = () => {
  ...
  // };
  const topicArray = Object.keys(topicData).map((key) => ({
    _id: key,
    ...topicData[key],
  }));
        ...
        <CardContainer>
          <Row gutter={[32, 32]} justify="center">
            {/* {Object.keys(topicData).map((topicId) => {
              ...
              console.log("Object.keys(topicData):", topic);

              return (
                <Col key={topicId} xs={8} sm={8} md={6} lg={4}>
                  <TopicCard onClick={() => handleTopicClick(topicId)}>
            ...
            {topicArray.map((topic) => (
              <Col key={topic._id} xs={8} sm={8} md={6} lg={4}>
